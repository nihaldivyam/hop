...
//go:embed templates/*.html static/style.css static/paste.css
var assets embed.FS
...
func (s *Server) staticPaste(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "text/css; charset=utf-8")
